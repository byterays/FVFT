				...
				<aside class="app-sidebar doc-sidebar ps ps--active-y">
					...
					<ul class="side-menu">
                        ...
                        <li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="admin-pricing.html">List Companies</a></li>
								<li><a class="slide-item" href="Ads.html">Add Company</a></li>
							</ul>
						</li>
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
                        ...
                        <li class="slide">
							...
							<ul class="slide-menu">
								<li><a class="slide-item" href="admin-pricing.html">List Pages</a></li>
								<li><a class="slide-item" href="Ads.html">Add Page</a></li>
							</ul>
						</li> 
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
