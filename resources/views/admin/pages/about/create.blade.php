...
@section('main')
    <div class="page-header">
        <h4 class="page-title">Create About</h4>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.about.store') }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">New About</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                ...
                                <input type="text" name="description" id="body_id" style="display:none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify" name="feature_image" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="4M" data-height="180">
                                </div>
                                <div class="form-group">
