                        ...
                        <div class="col-md-7">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="text-danger filter_name"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success == false) {
                            ...
                            $(".ui-slider-range.ui-corner-all.ui-widget-header").css({width:jsonData.profile_score});
                            $(".ui-slider-handle.ui-corner-all.ui-state-default").css({left: jsonData.profile_score});
