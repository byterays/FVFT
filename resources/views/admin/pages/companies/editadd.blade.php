                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="state_id" id="select-state" class="form-control select2 " value="{{isset($company->state_id)?$company->state_id:''}}" onchange="patchCities(this)">
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Cities</label>
                                                <select name="city_id" id="select-city" class="form-control select2 " value="{{isset($company->city_id)?$company->city_id:''}}">
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label class="custom-switch-checkbox">
                                                    <input type="checkbox" name="is_active" class="custom-switch-input"  {{isset($company->is_active)?$company->is_active?"checked":'':''}}>
                                                    <span class="custom-switch-indicator"></span>
                                                    <span class="custom-switch-description">Active</span>
                                                </label>
                                                <label class="custom-switch-checkbox">
                                                    <input type="checkbox" name="is_featured"  class="custom-switch-input" {{isset($company->is_featured)?$company->is_featured?"checked":'':''}}>
                                                    <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            ...
                                            <input type="text" name="contact_person_id" style="display:none;" value="{{isset($contact_person->id)?$contact_person->id:''}}">
                                            <div class="form-group p-4">
                                                <div class="form-group">
                                                    <label class="form-label">Name</label>
                                                    <input type="text" class="form-control" name="contact_person_name" placeholder="Name" value="{{isset($contact_person->name)?$contact_person->name:''}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Email</label>
                                                    <input type="text" class="form-control" name="contact_person_email" placeholder="Email" value="{{isset($contact_person->email)?$contact_person->email:''}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Phone</label>
                                                    <input type="text" class="form-control" name="contact_person_phone" placeholder="Phone" value="{{isset($contact_person->phone)?$contact_person->phone:''}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Position</label>
                                                    <input type="text" class="form-control" name="contact_person_position" placeholder="Position" value="{{isset($contact_person->position)?$contact_person->position:''}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="dropify" name="company_cover" data-height="180" data-default-file="{{isset($company->company_cover)?env('APP_URL').$company->company_cover:''}}">
                                            </div>
                                            <div class="form-group">
