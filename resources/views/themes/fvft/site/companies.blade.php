                                                        ...
                                                        <div class="d-sm-flex card-body p-3">
                                                            ...
                                                            <div class="item-card9 mt-3 mt-md-5">
                                                                ...
                                                                <div class="rating-stars d-inline-flex">
                                                                    ...
                                                                    ({{ count(data_get($item, 'jobs')) }} Job openings)
                                                                </div>
                                                            </div>
                                                            {{-- <div class="ml-auto">
                                                            ...
                                                            <div class="card-body table-responsive border-top">
                                                                <table class="table table-borderless w-100 m-0 text-nowrap ">
                                                                    ...
                                                                    {{--@if($item->company_email)--}}
                                                                        {{--<tr>--}}
                                                                            {{--<td class="px-0 py-1"><span class="font-weight-semibold">Email Address</span></td>--}}
                                                                            {{--<td class="p-1"><span>:</span></td>--}}
                                                                            {{--<td class="p-1"><span>{{ $item->company_email ?? '' }}</span></td>--}}
                                                                        {{--</tr>--}}
                                                                    {{--@endif--}}
                                                                    <tr>
                                                                        ...
                                                                        <td class="p-1"><span>:</span></td>
                                                                        <td class="p-1">
                                                                            @if(data_get($item, 'city.name')) <span>{{ data_get($item, 'city.name') }},</span> @endif
                                                                            <span>{{ data_get($item, 'country.name') }}</span>
                                                                            {{--<span>--}}
