                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="country_id" id="select-country" class="form-control select2  text-dark" value="{{isset($company->country_id)?$company->country_id:''}}" onchange="patchStates(this)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="state_id" id="select-state" class="form-control select2 text-dark" value="{{isset($company->state_id)?$company->state_id:''}}" onchange="patchCities(this)">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Cities</label>
                                            <select name="city_id" id="select-city" class="form-control select2 text-dark" value="{{isset($company->city_id)?$company->city_id:''}}">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group p-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-dark" name="contact_person_name" placeholder="Name" value="{{isset($contact_person->name)?$contact_person->name:''}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Email</label>
                                                <input type="text" class="form-control text-dark" name="contact_person_email" placeholder="Email" value="{{isset($contact_person->email)?$contact_person->email:''}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Phone</label>
                                                <input type="text" class="form-control text-dark" name="contact_person_phone" placeholder="Phone" value="{{isset($contact_person->phone)?$contact_person->phone:''}}" required>
                                            </div>
                                            <div class="form-group">
