...
@section('main')
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.industry.store') }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Industry Title">
