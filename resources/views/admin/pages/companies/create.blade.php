...
@section('main')
    ...
    <form action="{{ route('admin.companies.saveCompany') }}" id="companyForm" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group company_logo" id="company_logo">
                                    ...
                                    <input type="file" name="company_logo" class="dropify" data-allowed-file-extensions="png jpg jpeg" data-height="180">
                ...
                <div class="card m-b-20">
                    ...
                    <div class="card-body mb-0">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="company_email">Company Email ID&nbsp;<span class="req">*</span></label>
                                </div>
                                <div class="col-md-8">
