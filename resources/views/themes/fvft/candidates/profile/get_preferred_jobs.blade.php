                ...
                <div class="col-xl-9 col-lg-12 col-md-12">
                    <form action="{{ route('candidate.profile.post_preferred_jobs') }}" method="POST" id="preferenceForm">
                        ...
                        <div class="row">
                            ...
                            <h3 class="mt-5 ml-3">{{ __('Preferred Jobs') }}</h3>
                            <div class="card mb-2">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            @if ($employe->job_preferences->isEmpty())
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6 my-auto">
                                                            <div class="form-group">
                                                                <label class="custom-switch">
                                                                    ...
                                                                    <span
                                                                        class="custom-switch-description">{{ __('Notify me for job') }}</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="font-weight-normal mt-2 ml-3">
                                                            {{ __('Or Select your preferred job category') }}
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="font-weight-normal mt-2 ml-3">
                                                            {{ __('Or Add your preferred job title') }}
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="font-weight-normal mt-2 ml-3">
                                                            {{ __('Or Select your preferred country') }}
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                            ...
                                            @else
                                                @include(
                                                    'themes.fvft.candidates.profile.preference_partial'
                                                )
                                            @endif
                                        </div>
                                    </div>
