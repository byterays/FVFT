...
@if($delete)
    @if($delete["status"]=="success")
        <div id="statusmsg" class="alert alert-success fade show flash" role="alert" style="position: fixed;z-index: 11;top: 60px !important;right:20px;"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <i class="fa fa-check-circle-o mr-2" aria-hidden="true"></i> Candidate Deleted.</div>
    @else
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <div class="d-flex flex-row-reverse mb-2" >
                    ...
                    <a type="button" class="btn btn-primary" href="/admin/candidates/new"><i class="fe fe-plus mr-2"></i>Add New</a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div data-toggle="tooltip" data-original-title="View" style="display: inline-block;">
                                        <a class="btn btn-primary btn-sm text-white mb-1"  href="/candidate/{{$candidate->id}}" ><i class="fa fa-eye"></i></a>
                                    </div>
                                     <div data-toggle="tooltip" data-original-title="Edit" style="display: inline-block;">
                                        <a class="btn btn-success btn-sm text-white mb-1"  href="/admin/candidates/edit/{{$candidate->id}}"><i class="fa fa-pencil"></i></a>
                                    </div>
                                    <a class="btn btn-danger btn-sm text-white mb-1" data-toggle="tooltip" data-original-title="Delete" href="/admin/candidates/delete/{{$candidate->id}}"><i class="fa fa-trash-o"></i></a><br>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
