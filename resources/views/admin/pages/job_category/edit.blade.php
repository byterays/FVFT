...
@section('main')
    <div class="page-header">
        <h4 class="page-title">Edit Job Category</h4>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.job_category.update', $job_category->id) }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                @method('put')
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="functional_area" value="{{ $job_category->functional_area }}" placeholder="Job Category Title">
