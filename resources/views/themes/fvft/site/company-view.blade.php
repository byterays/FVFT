                            ...
                            <div class="wideget-user-tab">
                                <div class="tab-menu-heading">
                                    <div class="tabs-menu1">
                                        <ul class="nav">
                                            <li class=""><a href="#tab-5" class="@if(Request::get('page')==null)active @endif" data-toggle="tab">Profile</a></li>
                                            <li><a href="#tab-6" data-toggle="tab" class="@if(Request::get('page')!==null)active @endif">Company Jobs</a></li>
                        ...
                        <div class="tab-pane @if(Request::get('page')==null )active @endif" id="tab-5">
                            <div class="card mb-0 border-0">
                                <div class="card-body">
                                    <div class="profile-log-switch">
                                        ...
                                        <ul class="usertab-list mb-0">
                                            ...
                                            <li><a href="#" class="text-dark"><span class="font-weight-semibold w100">Email :</span>{{ $company->company_email ?? "Not-Available" }}</a></li>
                                            <li><a href="#" class="text-dark"><span class="font-weight-semibold w100">Phone :</span>{{ $company->company_phone ?? "Not-Available" }} </a></li>
                                        </ul>
                                        <div class="row profie-img">
                                            <div class="col-md-12">
                                                ...
                                                <p>{!! html_entity_decode($company->html_content_intro ?? "Not-Available") !!}</p>
                                ...
                                <div class="card-footer bg-light-50">
                                    <div class="icons">
                                        {{-- <a href="#" class="btn btn-success icons mb-1 mt-1" data-toggle="modal" data-target="#apply"><i class="fa fa-check mr-1"></i> Apply</a> --}}
                                        <a href="#" class="btn btn-primary icons mb-1 mt-1"><i class="si si-share mr-1"></i> Share Company</a>
                                        {{-- <a href="#" class="btn btn-info icons mb-1 mt-1"><i class="si si-printer  mr-1"></i> Print</a> --}}
                                                                        ...
                                                                        <div class="d-md-flex">
                                                                            <div class="p-0 m-0 item-card9-img">
                                                                                <div class="item-card9-imgs">
                                                                                    ...
                                                                                    @else
                                                                                        <img src="/uploads/defaultimage.jpg" alt="img" class="h-100">
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="card-footer pt-3 pb-3">
                                                                                    <div class="item-card9-footer d-sm-flex">
                                                                                        <div class="d-flex align-items-center mb-3 mb-md-0 mt-auto posted">
                                                                                            <div>
                                                                                                Posted by <a href="/company-view/{{$company->id}}" class="text-muted fs-12 mb-1"><span class="ml-0 fs-13"> {{ $company->company_name }}</span></a>
                                                                                                <small class="text-default">({{$item->updated_at->diffForHumans()}})</small>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="ml-auto">
