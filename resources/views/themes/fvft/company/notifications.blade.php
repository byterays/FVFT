    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-options">
                <a href="{{ route('company.read_notifications', ['type' => 'unread', 'id' => 0]) }}" class="btn btn-sm btn-primary mr-2"><i class="fa fa-check mr-1"></i> Mark all as read</a>
                                        ...
                                        <div class="{{ blank($notification->read_at) ? 'bg-secondary' : '' }} p-4">
                                            <label class="form-label">
                                                ...
                                                @if(blank($notification->read_at))
                                                    <a href="{{ route('company.read_notifications', ['type' => 'single', 'id' => $notification->id]) }}"
                                        ...
                                        <div class="{{ blank($unreadNotification->read_at) ? 'bg-secondary' : '' }} p-4">
                                            <label class="form-label">
                                                ...
                                                @if(blank($unreadNotification->read_at))
                                                    <a href="{{ route('company.read_notifications', ['type' => 'single', 'id' => $unreadNotification->id]) }}"
                                                       class="ml-4"><i class="mr-1 fa fa-check"></i>Mark as read</a>
                                                @else
