                 ...
                 @endif
							...
							<div class="card-body p-4">
								<div class="item7-card-desc d-flex mb-2">
									<a href="#"><i class="fa fa-calendar-o text-muted mr-2"></i>{{ \Carbon\Carbon::parse($item->updated_at)->diffForhumans() }}</a>
								</div>
								<a href="news/{{$item->slug}}" class="text-dark"><h4 class="font-weight-semibold">{{ $item->title }}</h4></a>
								<p>{{  Str::limit($item->short_description,50) }} </p>
								<div class="d-flex align-items-center pt-2 mt-auto">
									<img src="{{asset('/uploads/defaultimage.jpg')}}" class="avatar brround avatar-md mr-3" alt="avatar-img">
									<div>
