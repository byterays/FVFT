        ...
        <div class="card-body">
            ...
            <form action="{{ route('company.applicant.indexpage') }}" method="GET">
                ...
                <div class="applicant-per-page-section mt-5">
                    <div class="row">
                        <div class="col-md-4">
                            {{-- <form action="{{ route('company.applicant.indexpage') }}" method="GET" id="numOfApplicant"> --}}
                            <div class="form-group">
                                <div class="row">
            ...
            <div class="action-section">
                <div class="">
                    <a href="javascript:void(0)" onclick="updateBulkApplicantStatus('{{ ApplicantStatus::PENDING }}');"
                        class="btn btn-outline-secondary text-dark bg-white">Unscreened</a>
                    <a href="javascript:void(0)"
                        onclick="updateBulkApplicantStatus('{{ ApplicantStatus::SHORTLISTED }}');"
                        class="btn btn-outline-secondary text-dark bg-white ml-2">Shortlist</a>
                    <a href="javascript:void(0)"
                        onclick="updateBulkApplicantStatus('{{ ApplicantStatus::INTERVIEWED }}');"
                        class="btn btn-outline-secondary text-dark bg-white ml-2">Interviewed</a>
                    <a href="javascript:void(0)"
                        onclick="updateBulkApplicantStatus('{{ ApplicantStatus::SELECTEDFORINTERVIEW }}');"
                        class="btn btn-outline-secondary text-dark bg-white ml-2">Selected</a>
                    <a href="javascript:void(0)" onclick="updateBulkApplicantStatus('{{ ApplicantStatus::REJECTED }}');"
                        class="btn btn-outline-secondary text-dark bg-white ml-2">Reject</a>
                    <a href="javascript:void(0)" class="btn btn-outline-secondary text-dark bg-white ml-2">Schedule
                        Interview</a>
                    <a href="javascript:void(0)" class="btn btn-outline-secondary text-dark bg-white ml-2">Email</a>
                    <a href="javascript:void(0)" class="btn btn-outline-secondary text-dark bg-white ml-2">Message</a>
                    <a href="javascript:void(0)" onclick="bulkApplicationDelete();"
                        class="btn btn-outline-secondary text-dark bg-white mt-1">Delete</a>
                    <a href="javascript:void(0)" onclick="bulkCvDownload();"
                        class="btn btn-outline-secondary text-dark bg-white mt-1 ml-2">Download
                        CV</a>
                </div>
            </div>
        </div>
