...
@section('main')
    <div class="page-header">
        <h4 class="page-title">Create Support</h4>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.support.store') }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">New Support</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="support_types[]" class="form-control select2" multiple>
                                        @foreach ($support_types as $support_type)
                                            <option value="{{ $support_type->id }}">{{ $support_type->title }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="card-footer text-right">
                        <div class="d-flex">
                            ...
                            <button id="saveButton" type="button" onclick="submitForm(event);"
                                class="btn btn-success ml-auto">Save
                            </button>
                        </div>
                    </div>
                </div>
