    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-md-8" style="line-height: 1">
                <h5 class="font-weight-bold">{{ $employ->full_name }}</h5>
                <div class="info" style="line-height: 1">
                    ...
                    <h6>Email: {{ $employ->user != null ? $employ->user->email : '' }}</h6>
                    <h6>Phone: {{ $employ->mobile_phone }}</h6>
                </div>
            </div>
        </div>
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h6> {{ $employ->marital_status }}</h6>
                    </div>
                    <div class="col-md-4">
                        <h6>Date of Birth:</h6>
                    </div>
                    <div class="col-md-8">
                        <h6>{{ date('Y F d', strtotime($employ->dob)) }}</h6>
                    </div>
                    <div class="col-md-4">
                        <h6>Height:</h6>
                    </div>
                    <div class="col-md-8">
                        <h6> {{ $employ->height ? $employ->height . ' CM' : '' }}</h6>
                    </div>
                    <div class="col-md-4">
                        <h6>Weight:</h6>
                    </div>
                    <div class="col-md-8">
                        <h6>{{ $employ->weight ? $employ->weight . ' KG' : '' }}</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <p>1. <span>Police, 15 years 6 month, Government Service, Nepal</span></p>
                <p>2. <span>Security Guard, 3 years 4 month, Security Service, Malaysia, Sasa Security</span></p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                @if (json_decode($employ->trainings != null))
                    @foreach (json_decode($employ->trainings) as $etraining)
                        {{-- {{ wrapInTag(App\Models\Training::where('id', $etraining)->value('title') ?? '', 'p', 'class=""', ', ') }} --}}
                        {{ $loop->first ? '' : ',' }}
                    ...
                    @if ($employ->employeeLanguage != null)
                        @foreach ($employ->employeeLanguage as $elanguage)
                            @if ($elanguage->language != null)
                                <div class="col-md-4">
                                    <h6>{{ $elanguage->language != null ? $elanguage->language->lang : '' }}</h6>
                                </div>
                                <div class="col-md-8">
                                    <h6>{{ $elanguage->language_level }}</h6>
                                </div>
                            @endif
                        @endforeach
                    @endif
