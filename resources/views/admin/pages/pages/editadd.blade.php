                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="seo_title" placeholder="Slug" value="{{isset($page->title)?$page->title:''}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Seo Description</label>
                                                <textarea class="form-control" name="seo_description" rows="7" placeholder="Seo Description">{{isset($page->seo_description)?$page->seo_description:''}}</textarea>
                                            </div>
                            
                                            <div class="form-group">
                                                <label class="form-label">Seo Keywords</label>
                                                <input type="text" class="form-control" data-role="tagsinput"  name="seo_keywords" placeholder="Slug" value="{{isset($page->seo_keywords)?$page->seo_keywords:''}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Slug</label>
                                                <input type="text" class="form-control" name="slug" placeholder="Slug" value="{{isset($page->slug)?$page->slug:''}}" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="custom-switch-checkbox">
                                                    <input type="checkbox" name="is_active" class="custom-switch-input"  {{isset($page->is_active)?$page->is_active?"checked":'':'checked'}}>
