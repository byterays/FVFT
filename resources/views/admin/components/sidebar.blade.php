...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
				<aside class="app-sidebar doc-sidebar ps ps--active-y">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
                            <i class="side-menu__icon fa fa-cogs"></i><span class="side-menu__label">Settings</span>
							<i class="angle fa fa-angle-right"></i>
						</a>
							<ul class="slide-menu">
								<li>
									<a href="/admin/site-settings" class="slide-item"> Site Settings</a>
								</li>
								<li>
									<a href="/admin/edit-profile                                                                                                                                                                                                                                                                                                                                                                                                                  " class="slide-item"> Admin Profile</a>
								</li>
							</ul>
						</li>
