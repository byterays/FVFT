                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="wideget-user-desc d-sm-flex">
                                            ...
                                            <div class="user-wrap wideget-user-info"> <a href="#" class="text-dark">
                                                    <h4 class="font-weight-semibold mb-2">{{ $company->company_name }}</h4>
                                                </a>
                                                <h6 class="text-muted mb-1"><span class="text-dark">Followers : </span>
                                                    <span id="count_{{ $company->id }}">({{ $company->followers->count() }})</span></h6>
                            ...
                            <div class="card mb-0 border-0">
                                    ...
                                    <div class="profile-log-switch">
                                        ...
                                        <ul class="usertab-list mb-0">
                                            <p><a href="#" class="text-dark"><span
                                                    ...
                                                    {{ @DB::table('countries')->find($company->country_id)->name }}</a></p>
                                ...
                                <div class="card-footer bg-light-50">
                                    <div class="icons">
                                        ...
                                        <a href="#" class="btn btn-primary icons mb-1 mt-1"><i class="si si-share mr-1"></i>
                                            Share Company</a>
